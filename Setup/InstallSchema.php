...
class InstallSchema implements InstallSchemaInterface
{
    ...
    public function install(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        if (!$installer->tableExists('mavenbird_brand')) {
            $table = $installer->getConnection()
                ->newTable($installer->getTable('mavenbird_brand'))
                ...
                ->addForeignKey(
                    $installer->getFkName('mavenbird_brand', 'option_id', 'eav_attribute_option', 'option_id'),
                    'option_id',
                ...
                ->addIndex(
                    $installer->getIdxName('mavenbird_brand', ['option_id', 'store_id'], true),
                    ['option_id', 'store_id'],
                    ['type' => 'unique']
                )
